...
class RecentlyPlayed extends StatefulWidget {
  final String uid;
  const RecentlyPlayed({Key? key, required this.uid}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PaginateFirestore(
        ...
        shrinkWrap: true,
        isLive: true,
        query: usersCollection.doc(widget.uid).collection("recentlyPlayed").orderBy("lastPlayed"),
        itemBuilderType: PaginateBuilderType.listView,
        itemBuilder: (context, documentSnapshots, index) {
          DocumentSnapshot recent = documentSnapshots[index];
          return StreamBuilder(
            stream: musicCollections.doc(recent.id).snapshots(),
